...
if not exist "$(IncDir)\\bitos.h" copy "..\\..\\src\\paks\\bitos\\bitos.h" "$(IncDir)\\bitos.h"
if not exist "$(IncDir)\\me.h" copy "..\\${settings.product}-${platform.os}-${platform.profile}-me.h" "$(IncDir)\\me.h"
'
var prepTarget
var Base 
