/*
    Generator.es -- Generator class for MakeMe native projects
...
class Generator {
   ...
   function generateShellProject(base: Path) {
    ...
    function genTargets() {
        builder.selectTargets('generate')
