/*
    Configure.es -- Configuration MakeMe plugin
...
class Configure {
    ...
    public function configure() {
        ...
        if (!options.gen) {
            /*
                Compute the platforms from the command line switches and the settings.platforms property in main.me
                If none specified, use the local platform.
            */
            ...
            if (settings && settings.platforms) {
                ...
                /* Ensure local is first to build dev tools  */
