#
#   bit-windows-default.sh -- Build It Shell Script to build Embedthis Bit
#
...
"${LD}" -dll -out:${CONFIG}/bin/libejs.dll -entry:_DllMainCRTStartup@12 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejsLib.obj libsqlite3.lib libmpr.lib libpcre.lib libhttp.lib ${LIBS} libpcre.lib libmpr.lib
