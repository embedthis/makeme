#
#   bit-freebsd-default.mk -- Makefile to build Embedthis Bit - Built It Tool for freebsd
#
...
$(CONFIG)/bin/bit: $(DEPS_35)
	...
	$(CC) -o $(CONFIG)/bin/bit $(LIBPATHS) "$(CONFIG)/obj/bit.o" $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) $(LIBS) 
