...
$(BUILD)/bin/makeme-ejsc: $(DEPS_41)
	...
	$(CC) -o $(BUILD)/bin/makeme-ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/ejsc.o" $(LIBPATHS_41) $(LIBS_41) $(LIBS_41) $(LIBS) 
endif
...
$(BUILD)/bin/makeme-ejs: $(DEPS_45)
	...
	$(CC) -o $(BUILD)/bin/makeme-ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/ejs.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) -ledit 
endif
