...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/makeme-linux-$(PROFILE)-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/makeme-linux-$(PROFILE)-me.h >/dev/null ; then\
		cp projects/makeme-linux-$(PROFILE)-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/obj/ejs.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ejs.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/ejscript/ejs.c
...
$(BUILD)/obj/ejsLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ejsLib.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/ejscript/ejsLib.c
...
$(BUILD)/obj/ejsc.o: \
	...
	$(CC) -c -o $(BUILD)/obj/ejsc.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/ejscript/ejsc.c
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/http/http.c
...
$(BUILD)/obj/httpLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/httpLib.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/http/httpLib.c
...
$(BUILD)/obj/me.o: \
	...
	$(CC) -c -o $(BUILD)/obj/me.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/me.c
...
$(BUILD)/obj/mprLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/mprLib.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/mpr/mprLib.c
...
$(BUILD)/obj/pcre.o: \
	...
	$(CC) -c -o $(BUILD)/obj/pcre.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/pcre/pcre.c
...
$(BUILD)/obj/testme.o: \
	...
	$(CC) -c -o $(BUILD)/obj/testme.o -Wno-unknown-warning-option -fPIC $(DFLAGS) $(IFLAGS) src/tm/testme.c
...
$(BUILD)/obj/zlib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/zlib.o -Wno-unknown-warning-option -fPIC -Wno-deprecated-non-prototype $(DFLAGS) $(IFLAGS) src/zlib/zlib.c
