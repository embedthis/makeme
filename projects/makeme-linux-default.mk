...
$(CONFIG)/bin/libejs.so: $(DEPS_23)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_23) $(LIBS_23) $(LIBS_23) $(LIBS) 
endif
...
$(CONFIG)/bin/ejscmd: $(DEPS_25)
	...
	$(CC) -o $(CONFIG)/bin/ejscmd $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_25) $(LIBS_25) $(LIBS_25) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_27)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_27) $(LIBS_27) $(LIBS_27) $(LIBS) $(LIBS) 
endif
