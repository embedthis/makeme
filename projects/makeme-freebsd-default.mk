...
$(CONFIG)/bin/http: $(DEPS_31)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/me: $(DEPS_35)
	...
	$(CC) -o $(CONFIG)/bin/me $(LIBPATHS) "$(CONFIG)/obj/me.o" $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) $(LIBS) 
