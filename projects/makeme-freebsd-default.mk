...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/makeme-freebsd-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/makeme-freebsd-default-me.h >/dev/null ; then\
		cp projects/makeme-freebsd-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
$(CONFIG)/bin/ejscmd: $(DEPS_22)
	...
	$(CC) -o $(CONFIG)/bin/ejscmd $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_24)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_24) $(LIBS_24) $(LIBS_24) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/httpcmd: $(DEPS_31)
	...
	$(CC) -o $(CONFIG)/bin/httpcmd $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_33)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) 
...
$(CONFIG)/bin/sqlite: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/sqlite $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/me: $(DEPS_40)
	...
	$(CC) -o $(CONFIG)/bin/me $(LIBPATHS) "$(CONFIG)/obj/me.o" $(LIBPATHS_40) $(LIBS_40) $(LIBS_40) $(LIBS) $(LIBS) 
