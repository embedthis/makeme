...
me.mod: $(DEPS_39)
	/Users/mob/git/me/build/macosx-x64-default/bin/ejsc --out /Users/mob/git/me/build/macosx-x64-default/bin/me.mod --optimize 9 /Users/mob/git/me/src/me.es /Users/mob/git/me/src/paks/ejs-version/Version.es
#
#   me.o
#
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_45 += build/$(CONFIG)/bin/libzlib.dylib
endif
...
ifeq ($(ME_COM_EJS),1)
    DEPS_45 += build/$(CONFIG)/bin/libejs.dylib
endif
...
build/$(CONFIG)/bin/testme: $(DEPS_45)
	...
	$(CC) -o build/$(CONFIG)/bin/testme -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/testme.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) 
