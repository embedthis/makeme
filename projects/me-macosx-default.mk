...
ejs.testme.mod: $(DEPS_25)
	cd src/tm; /Users/mob/git/me/build/macosx-x64-default/bin/ejsc --debug --out /Users/mob/git/me/build/macosx-x64-default/bin/ejs.testme.mod --optimize 9 /Users/mob/git/me/src/tm/ejs.testme.es ; cd ../..
#
#   ejs.o
#
...
build/$(CONFIG)/bin/me: $(DEPS_42)
	...
	$(CC) -o build/$(CONFIG)/bin/me -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/me.o" $(LIBPATHS_42) $(LIBS_42) $(LIBS_42) $(LIBS) 
...
testme.mod: $(DEPS_45)
	cd src/tm; /Users/mob/git/me/build/macosx-x64-default/bin/ejsc --debug --out /Users/mob/git/me/build/macosx-x64-default/bin/testme.mod --optimize 9 /Users/mob/git/me/src/tm/testme.es ; cd ../..
#
#   testme.o
#
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_47 += build/$(CONFIG)/bin/libzlib.dylib
endif
...
ifeq ($(ME_COM_EJS),1)
    DEPS_47 += build/$(CONFIG)/bin/libejs.dylib
endif
...
build/$(CONFIG)/bin/testme: $(DEPS_47)
	...
	$(CC) -o build/$(CONFIG)/bin/testme -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/testme.o" $(LIBPATHS_47) $(LIBS_47) $(LIBS_47) $(LIBS) 
