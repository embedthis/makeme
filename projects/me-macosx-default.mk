...
$(BUILD)/bin/libmpr.dylib: $(DEPS_25)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 0.8 -current_version 0.8 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_25) $(LIBS_25) $(LIBS_25) $(LIBS) 
...
installBinary: $(DEPS_47)
	...
	cp paks/me-configuration/** $(ME_VAPP_PREFIX)/bin/paks/me-configuration/** ; \
	...
	cp paks/me-project/** $(ME_VAPP_PREFIX)/bin/paks/me-project/** ; \
