...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_14)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmprssl.dylib -compatibility_version 0.8.5 -current_version 0.8.5 $(CONFIG)/obj/mprSsl.o $(LIBPATHS_14) $(LIBS_14) $(LIBS_14) $(LIBS) 
...
$(CONFIG)/bin/makerom: $(DEPS_16)
	...
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_16) $(LIBS_16) $(LIBS_16) $(LIBS) 
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_22)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 0.8.5 -current_version 0.8.5 $(CONFIG)/obj/httpLib.o $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) 
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_30)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 0.8.5 -current_version 0.8.5 $(CONFIG)/obj/ejsLib.o $(LIBPATHS_30) $(LIBS_30) $(LIBS_30) $(LIBS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_32)
	...
	$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) -ledit 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/ejsc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
endif
...
ifeq ($(BIT_PACK_EJSCRIPT),1)
    DEPS_38 += $(CONFIG)/bin/libejs.dylib
endif
...
$(CONFIG)/bin/bit: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/bit -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/bit.o $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
