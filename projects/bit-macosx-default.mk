...
BIT_PRODUCTVER_PREFIX := $(BIT_PRODUCT_PREFIX)/$(VERSION)
...
deploy: compile
	...
	rm -f $(BIT_PRODUCT_PREFIX)/latest $(BIT_UBIN_PREFIX)/bit $(BIT_VER_PREFIX)/man/man1/bit.1 $(BIT_MAN_PREFIX)/bit.1
	...
	ln -s $(VERSION) $(BIT_PRODUCT_PREFIX)/latest

install: compile deploy
	

uninstall: 
	rm -rf $(BIT_UBIN_PREFIX)/bit $(BIT_MAN_PREFIX)/bit.1 '$(BIT_PRODUCT_PREFIX)'
