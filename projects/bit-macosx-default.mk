...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_12)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmprssl.dylib -compatibility_version 0.9.4 -current_version 0.9.4 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_12) $(LIBS_12) $(LIBS_12) $(LIBS) 
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_23)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 0.9.4 -current_version 0.9.4 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_23) $(LIBS_23) $(LIBS_23) $(LIBS) 
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_30)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 0.9.4 -current_version 0.9.4 "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_30) $(LIBS_30) $(LIBS_30) $(LIBS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_32)
	...
	$(CC) -o $(CONFIG)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) -ledit 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
endif
...
$(CONFIG)/bin/bit: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/bit -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/bit.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
