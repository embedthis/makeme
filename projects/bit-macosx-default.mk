...
$(CONFIG)/bin/bit.es: \
    src/bit.es
	mkdir -p "macosx-x64-default/bin"
	cp "src/bit.es" "macosx-x64-default/bin/bit.es"
...
$(CONFIG)/bin/bits: \
    ...
    bits/vstudio.es \
    bits/xcode.es
	mkdir -p "macosx-x64-default/bin/bits"
	cp "bits/embedthis-manifest.bit" "macosx-x64-default/bin/bits/embedthis-manifest.bit"
	cp "bits/embedthis.bit" "macosx-x64-default/bin/bits/embedthis.bit"
	cp "bits/embedthis.es" "macosx-x64-default/bin/bits/embedthis.es"
	cp "bits/gendoc.es" "macosx-x64-default/bin/bits/gendoc.es"
	mkdir -p "macosx-x64-default/bin/bits/os"
	cp "bits/os/freebsd.bit" "macosx-x64-default/bin/bits/os/freebsd.bit"
	cp "bits/os/gcc.bit" "macosx-x64-default/bin/bits/os/gcc.bit"
	cp "bits/os/linux.bit" "macosx-x64-default/bin/bits/os/linux.bit"
	cp "bits/os/macosx.bit" "macosx-x64-default/bin/bits/os/macosx.bit"
	cp "bits/os/posix.bit" "macosx-x64-default/bin/bits/os/posix.bit"
	cp "bits/os/solaris.bit" "macosx-x64-default/bin/bits/os/solaris.bit"
	cp "bits/os/vxworks.bit" "macosx-x64-default/bin/bits/os/vxworks.bit"
	cp "bits/os/windows.bit" "macosx-x64-default/bin/bits/os/windows.bit"
	cp "bits/os/freebsd.bit" "macosx-x64-default/bin/bits/os/freebsd.bit"
	cp "bits/os/gcc.bit" "macosx-x64-default/bin/bits/os/gcc.bit"
	cp "bits/os/linux.bit" "macosx-x64-default/bin/bits/os/linux.bit"
	cp "bits/os/macosx.bit" "macosx-x64-default/bin/bits/os/macosx.bit"
	...
	cp "bits/os/vxworks.bit" "macosx-x64-default/bin/bits/os/vxworks.bit"
	cp "bits/os/windows.bit" "macosx-x64-default/bin/bits/os/windows.bit"
	mkdir -p "macosx-x64-default/bin/bits/packs"
	cp "bits/packs/compiler.pak" "macosx-x64-default/bin/bits/packs/compiler.pak"
	cp "bits/packs/doxygen.pak" "macosx-x64-default/bin/bits/packs/doxygen.pak"
	cp "bits/packs/dsi.pak" "macosx-x64-default/bin/bits/packs/dsi.pak"
	cp "bits/packs/dumpbin.pak" "macosx-x64-default/bin/bits/packs/dumpbin.pak"
	cp "bits/packs/ejs.pak" "macosx-x64-default/bin/bits/packs/ejs.pak"
	cp "bits/packs/ejscript.pak" "macosx-x64-default/bin/bits/packs/ejscript.pak"
	cp "bits/packs/est.pak" "macosx-x64-default/bin/bits/packs/est.pak"
	cp "bits/packs/http.pak" "macosx-x64-default/bin/bits/packs/http.pak"
	cp "bits/packs/lib.pak" "macosx-x64-default/bin/bits/packs/lib.pak"
	cp "bits/packs/link.pak" "macosx-x64-default/bin/bits/packs/link.pak"
	cp "bits/packs/man.pak" "macosx-x64-default/bin/bits/packs/man.pak"
	cp "bits/packs/man2html.pak" "macosx-x64-default/bin/bits/packs/man2html.pak"
	cp "bits/packs/matrixssl.pak" "macosx-x64-default/bin/bits/packs/matrixssl.pak"
	cp "bits/packs/md5.pak" "macosx-x64-default/bin/bits/packs/md5.pak"
	cp "bits/packs/mocana.pak" "macosx-x64-default/bin/bits/packs/mocana.pak"
	cp "bits/packs/openssl.pak" "macosx-x64-default/bin/bits/packs/openssl.pak"
	cp "bits/packs/pcre.pak" "macosx-x64-default/bin/bits/packs/pcre.pak"
	cp "bits/packs/pmaker.pak" "macosx-x64-default/bin/bits/packs/pmaker.pak"
	cp "bits/packs/ranlib.pak" "macosx-x64-default/bin/bits/packs/ranlib.pak"
	cp "bits/packs/rc.pak" "macosx-x64-default/bin/bits/packs/rc.pak"
	cp "bits/packs/sqlite.pak" "macosx-x64-default/bin/bits/packs/sqlite.pak"
	cp "bits/packs/ssl.pak" "macosx-x64-default/bin/bits/packs/ssl.pak"
	cp "bits/packs/strip.pak" "macosx-x64-default/bin/bits/packs/strip.pak"
	cp "bits/packs/tidy.pak" "macosx-x64-default/bin/bits/packs/tidy.pak"
	cp "bits/packs/utest.pak" "macosx-x64-default/bin/bits/packs/utest.pak"
	cp "bits/packs/vxworks.pak" "macosx-x64-default/bin/bits/packs/vxworks.pak"
	cp "bits/packs/winsdk.pak" "macosx-x64-default/bin/bits/packs/winsdk.pak"
	cp "bits/packs/zip.pak" "macosx-x64-default/bin/bits/packs/zip.pak"
	cp "bits/packs/zlib.pak" "macosx-x64-default/bin/bits/packs/zlib.pak"
	cp "bits/packs/compiler.pak" "macosx-x64-default/bin/bits/packs/compiler.pak"
	cp "bits/packs/doxygen.pak" "macosx-x64-default/bin/bits/packs/doxygen.pak"
	cp "bits/packs/dsi.pak" "macosx-x64-default/bin/bits/packs/dsi.pak"
	cp "bits/packs/dumpbin.pak" "macosx-x64-default/bin/bits/packs/dumpbin.pak"
	...
	cp "bits/packs/zip.pak" "macosx-x64-default/bin/bits/packs/zip.pak"
	cp "bits/packs/zlib.pak" "macosx-x64-default/bin/bits/packs/zlib.pak"
	cp "bits/sample-main.bit" "macosx-x64-default/bin/bits/sample-main.bit"
	cp "bits/sample-start.bit" "macosx-x64-default/bin/bits/sample-start.bit"
	cp "bits/simple.bit" "macosx-x64-default/bin/bits/simple.bit"
	cp "bits/standard.bit" "macosx-x64-default/bin/bits/standard.bit"
	cp "bits/vstudio.es" "macosx-x64-default/bin/bits/vstudio.es"
	cp "bits/xcode.es" "macosx-x64-default/bin/bits/xcode.es"
...
installBinary: stop
	...
	mkdir -p "/usr/local/lib/bit/0.8.2/doc/man"
	cp "doc/man/bit.1" "/usr/local/lib/bit/0.8.2/doc/man/man1"
	rm -f "/usr/local/share/man/man1/man1"
	mkdir -p "/usr/local/share/man/man1"
	ln -s "/usr/local/lib/bit/0.8.2/doc/man/man1" "/usr/local/share/man/man1/man1"
...
uninstall: stop
	...
	rmdir -p "/usr/local/lib/bit/0.8.2"
