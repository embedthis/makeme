...
installBinary: $(DEPS_37)
	...
	cp "$(CONFIG)/bin/bits/bit.es" "$(BIT_VAPP_PREFIX)/bin/bits/bit.es"
	cp "$(CONFIG)/bin/bits/configure.es" "$(BIT_VAPP_PREFIX)/bin/bits/configure.es"
	cp "$(CONFIG)/bin/bits/embedthis-manifest.bit" "$(BIT_VAPP_PREFIX)/bin/bits/embedthis-manifest.bit"
	cp "$(CONFIG)/bin/bits/embedthis.bit" "$(BIT_VAPP_PREFIX)/bin/bits/embedthis.bit"
	cp "$(CONFIG)/bin/bits/embedthis.es" "$(BIT_VAPP_PREFIX)/bin/bits/embedthis.es"
	cp "$(CONFIG)/bin/bits/gendoc.es" "$(BIT_VAPP_PREFIX)/bin/bits/gendoc.es"
	cp "$(CONFIG)/bin/bits/generate.es" "$(BIT_VAPP_PREFIX)/bin/bits/generate.es"
	mkdir -p "$(BIT_VAPP_PREFIX)/bin/bits/os"
	cp "$(CONFIG)/bin/bits/os/freebsd.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/freebsd.bit"
	cp "$(CONFIG)/bin/bits/os/gcc.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/gcc.bit"
	cp "$(CONFIG)/bin/bits/os/linux.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/linux.bit"
	cp "$(CONFIG)/bin/bits/os/macosx.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/macosx.bit"
	cp "$(CONFIG)/bin/bits/os/solaris.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/solaris.bit"
	cp "$(CONFIG)/bin/bits/os/unix.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/unix.bit"
	cp "$(CONFIG)/bin/bits/os/vxworks.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/vxworks.bit"
	cp "$(CONFIG)/bin/bits/os/windows.bit" "$(BIT_VAPP_PREFIX)/bin/bits/os/windows.bit"
	mkdir -p "$(BIT_VAPP_PREFIX)/bin/bits/packs"
	cp "$(CONFIG)/bin/bits/packs/compiler.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/compiler.bit"
	cp "$(CONFIG)/bin/bits/packs/doxygen.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/doxygen.bit"
	cp "$(CONFIG)/bin/bits/packs/dsi.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/dsi.bit"
	cp "$(CONFIG)/bin/bits/packs/dumpbin.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/dumpbin.bit"
	cp "$(CONFIG)/bin/bits/packs/ejs.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/ejs.bit"
	cp "$(CONFIG)/bin/bits/packs/ejscript.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/ejscript.bit"
	cp "$(CONFIG)/bin/bits/packs/est.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/est.bit"
	cp "$(CONFIG)/bin/bits/packs/http.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/http.bit"
	cp "$(CONFIG)/bin/bits/packs/lib.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/lib.bit"
	cp "$(CONFIG)/bin/bits/packs/link.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/link.bit"
	cp "$(CONFIG)/bin/bits/packs/man.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/man.bit"
	cp "$(CONFIG)/bin/bits/packs/man2html.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/man2html.bit"
	cp "$(CONFIG)/bin/bits/packs/matrixssl.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/matrixssl.bit"
	cp "$(CONFIG)/bin/bits/packs/md5.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/md5.bit"
	cp "$(CONFIG)/bin/bits/packs/nanossl.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/nanossl.bit"
	cp "$(CONFIG)/bin/bits/packs/openssl.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/openssl.bit"
	cp "$(CONFIG)/bin/bits/packs/pcre.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/pcre.bit"
	cp "$(CONFIG)/bin/bits/packs/pmaker.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/pmaker.bit"
	cp "$(CONFIG)/bin/bits/packs/ranlib.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/ranlib.bit"
	cp "$(CONFIG)/bin/bits/packs/rc.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/rc.bit"
	cp "$(CONFIG)/bin/bits/packs/sqlite.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/sqlite.bit"
	cp "$(CONFIG)/bin/bits/packs/ssl.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/ssl.bit"
	cp "$(CONFIG)/bin/bits/packs/strip.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/strip.bit"
	cp "$(CONFIG)/bin/bits/packs/tidy.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/tidy.bit"
	cp "$(CONFIG)/bin/bits/packs/utest.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/utest.bit"
	cp "$(CONFIG)/bin/bits/packs/vxworks.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/vxworks.bit"
	cp "$(CONFIG)/bin/bits/packs/winsdk.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/winsdk.bit"
	cp "$(CONFIG)/bin/bits/packs/zip.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/zip.bit"
	cp "$(CONFIG)/bin/bits/packs/zlib.bit" "$(BIT_VAPP_PREFIX)/bin/bits/packs/zlib.bit"
	cp "$(CONFIG)/bin/bits/sample-main.bit" "$(BIT_VAPP_PREFIX)/bin/bits/sample-main.bit"
	cp "$(CONFIG)/bin/bits/sample-start.bit" "$(BIT_VAPP_PREFIX)/bin/bits/sample-start.bit"
	cp "$(CONFIG)/bin/bits/simple.bit" "$(BIT_VAPP_PREFIX)/bin/bits/simple.bit"
	cp "$(CONFIG)/bin/bits/standard.bit" "$(BIT_VAPP_PREFIX)/bin/bits/standard.bit"
	cp "$(CONFIG)/bin/bits/vstudio.es" "$(BIT_VAPP_PREFIX)/bin/bits/vstudio.es"
	cp "$(CONFIG)/bin/bits/xcode.es" "$(BIT_VAPP_PREFIX)/bin/bits/xcode.es"
