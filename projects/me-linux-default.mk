...
$(BUILD)/bin/libmprssl.so: $(DEPS_38)
	@echo '      [Link] $(BUILD)/bin/libmprssl.so'
	$(CC) -shared -o $(BUILD)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
...
$(BUILD)/bin/libtestme.so: $(DEPS_39)
