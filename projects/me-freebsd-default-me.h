...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/me/0.8.8"
#endif
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform freebsd-x86-default -configure . --without ssl -gen make"
#endif
